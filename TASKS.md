...
- T3.3 Hidden choice. Forced by T3.2 finding 6. Test the general claim: verification buys denial only when the defender's right preventive move depends on the rival's hidden choice. Smallest world change: two capability domains; a strike succeeds in the domain the striker chooses; defense is domain-specific. Acceptance: blind versus verified sure prevention differs in some cells; name them; behavior paired as before. A world where blind equals verified again contradicts the claim.
