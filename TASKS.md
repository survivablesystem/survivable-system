...
- A1 case recorded: treaty finding 4. [claimed: Claude, 2026-09-23: swept opponent model, decision 2026-09-23] The root opponent model (others repeat their last action) decides whether a trailer anticipates a leader's build. Compare a root-level best-response or sampled-prior model before relying on first-strike timing.
